...
import { GarminLogo, StravaLogo } from '@/components/LandingPage/PlatformLogos'
import FeaturesSection from '@/components/LandingPage/FeaturesSection'
import SampleWeekComparison from '@/components/LandingPage/SampleWeekComparison'
import EmailPreviewSection from '@/components/LandingPage/EmailPreviewSection'
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-700 text-lg max-w-2xl mx-auto">
              Three simple steps to personalized training
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-3xl blur opacity-25 group-hover:opacity-50 transition duration-300"></div>
              <div className="relative bg-white border-2 border-blue-100 rounded-3xl shadow-xl p-8 h-full">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-400 to-purple-500 rounded-2xl flex items-center justify-center mb-6">
